		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Oil Refinery Configuration",
									"targetURL": "#comoilrefconf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comoilrefconf-display": {
								"semanticObject": "comoilrefconf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.oil.refconf",
									"url": sap.ui.require.toUrl("com/oil/refconf")
								}
							}
						}
					}
